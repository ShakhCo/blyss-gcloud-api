...
- For services: label = "name - price so'm", value = service ID.
- For dates: label = "day_name, date", value = the date.
- For time slots: show up to 12 slots. label = "HH:MM", value = seconds from midnight as string.
